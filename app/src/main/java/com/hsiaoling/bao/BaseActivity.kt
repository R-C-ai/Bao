             ...
             when {
                 Build.VERSION.SDK_INT >= Build.VERSION_CODES.P -> {
                     ...
                     window?.let {
                         ...
                         Log.d("Hsiao","displayCutout?.safeInsetTop=${displayCutout?.safeInsetTop}")
                         Log.d("Hsiao","displayCutout?.safeInsetBottom=${displayCutout?.safeInsetBottom}")
                         Log.d("Hsiao","displayCutout?.safeInsetLeft=${displayCutout?.safeInsetLeft}")
                         Log.d("Hsiao","displayCutout?.safeInsetRight=${displayCutout?.safeInsetRight}")

                         val rects: List<Rect>? = displayCutout?.boundingRects
                         Log.d("Hsiao","rects?.size=${rects?.size}")
                         Log.d("Hsiao","rects=$rects")
